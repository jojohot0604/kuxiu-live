...
function() {
    return function(e) {
        ...
        function a(e, t) {
            if (d.IS_MOBILE ? (e.flash = !1, d.IS_X5TBS && e.x5_player ? w.mobile = ["flv", "m3u8", "mp4"] : d.IS_ENABLED_MSE && e.h5_flv && (w.mobile = ["flv", "m3u8", "mp4"])) : (e.flash = !!t.isFormat("rtmp") || e.flash, t.isFormat("flv") && void 0 == e.flash && (e.flash = !0), e.flash ? (!d.IS_ENABLED_FLASH || d.IS_MAC && d.IS_SAFARI) && (e.flash = !1, d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? w.pc = ["flv", "m3u8", "mp4"] : w.pc = ["m3u8", "mp4"] : w.pc = ["mp4"]) : d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? w.pc = ["flv", "m3u8", "mp4"] : w.pc = ["m3u8", "mp4"] : !d.IS_ENABLED_FLASH || d.IS_MAC && d.IS_SAFARI ? w.pc = ["mp4"] : e.flash = !0), e.clarity) {
            ...
            if (document.all || f) {
                try {
                    if (e = new ActiveXObject("ShockwaveFlash.ShockwaveFlash")) {
                        return t.FLASH_VERSION = v = e.GetVariable("$version").split(" ")[1].replace(/,/g, "."),
                        !0
                    }
                } catch(i) {
                    return ! 1
                ...
                try {
                    if (navigator.plugins && navigator.plugins.length > 0 && (e = navigator.plugins["Shockwave Flash"])) {
                        for (var o = e.description.split(" "), n = 0; n < o.length; ++n) {
                            isNaN(parseInt(o[n])) || (t.FLASH_VERSION = v = o[n])
                        }
                        return ! 0
                    }
                } catch(i) {
    ...
    function(e, t, i) {
        ...
        function l(e) {
            p.__isFullscreen = !!document[S.fullscreenElement],
            p.__isFullscreen || m.off(document, S.fullscreenchange, l),
            g.pub({
        ...
        function c(e, t) {
            m.off(t.video.el, "webkitbeginfullscreen", c),
            "webkitbeginfullscreen" == e.type ? (m.on(t.video.el, "webkitendfullscreen",
            function(e) {
                c(e, t)
            }), g.pub({
                type: b.MSG.FullScreen,
            ...
            p.player)) : "webkitendfullscreen" == e.type && (m.off(t.video.el, "webkitendfullscreen", c), g.pub({
                type: b.MSG.FullScreen,
                src: "util",
                ts: e.timeStamp,
                detail: {
        ...
        function p(e, t, i) {
            ...
            p.player = e,
            S.requestFullscreen ? t ? (m.on(document, S.fullscreenchange, l), i && i[S.requestFullscreen]()) : document[S.exitFullscreen]() : o && e.video.el.webkitEnterFullScreen ? (m.on(e.video.el, "webkitbeginfullscreen",
            function(t) {
                c(t, e)
            }), t ? e.video.el.webkitEnterFullScreen() : e.video.el.webkitExitFullscreen()) : (p.__isFullscreen = t, p.__isFullscreen ? (p.__origOverflow = document.documentElement.style.overflow, document.documentElement.style.overflow = "hidden", m.on(document, "keydown", u)) : (document.documentElement.style.overflow = p.__origOverflow, m.off(document, "keydown", u)), m.toggleClass(document.body, "vcp-full-window", t), g.pub({
                type: b.MSG.FullScreen,
                src: "util",
                detail: {
                    isFullscreen: p.__isFullscreen
        ...
        t.compareVersion = f,
        t.escapeHTML = y;
        for (var v = i(2), m = o(v), b = i(4), g = o(b), _ = i(1), w = (o(_), 1), S = t.FullscreenApi = {
    ...
    function(e, t, i) {
        t = e.exports = i(8)(),
        t.push([e.id, '.vcp-player{top:2px;position:relative;z-index:0;font-family:Tahoma,\\\\5FAE\\8F6F\\96C5\\9ED1,\\u5b8b\\u4f53,Verdana,Arial,sans-serif;background-color:#000}.vcp-player video{width:100%;display:block;overflow:hidden}.vcp-fullscreen video,.vcp-fullscreen.vcp-player,body.vcp-full-window{width:100%!important;height:100%!important}body.vcp-full-window{overflow-y:auto}.vcp-full-window .vcp-player{position:fixed;left:0;top:0;z-index:2147483647}.vcp-pre-flash,.vcp-video{width:100%;height:100%}.vcp-pre-flash{z-index:999;background:#000;position:absolute;top:0;left:0}.vcp-controls-panel{position:absolute;bottom:0;width:100%;font-size:12px;height:36px;z-index:1000}.vcp-controls-panel.show{-webkit-animation:fadeIn ease .8s;animation:fadeIn ease .8s;animation-fill-mode:forwards;-webkit-animation-fill-mode:forwards}.vcp-controls-panel.hide{-webkit-animation:fadeOut ease .8s;animation:fadeOut ease .8s;animation-fill-mode:forwards;-webkit-animation-fill-mode:forwards}.vcp-panel-bg{width:100%;height:100%;position:absolute;left:0;top:0;background-color:#090909;opacity:.6;filter:alpha(opacity=60);z-index:1000}.vcp-playtoggle{cursor:pointer;position:relative;z-index:1001;width:36px;height:100%;float:left;background:url(//img.17kuxiu.com/web/live/kuxiu/img/play.png) no-repeat;background-position:11px 11px}.vcp-playtoggle:focus,.vcp-playtoggle:hover{background-color:#708090;opacity:.9;filter:alpha(opacity=90)}.touchable .vcp-playtoggle:hover{background-color:transparent;opacity:1}.vcp-playing .vcp-playtoggle{background:url(//img.17kuxiu.com/web/live/kuxiu/img/pause.png) no-repeat;background-position:11px 11px}.vcp-bigplay{width:100%;height:96%;position:absolute;background-color:white\\0;filter:alpha(opacity=0);opacity:0;z-index:1000;top:0;left:0}.vcp-slider{position:relative;z-index:1001;float:left;background:#c4c4c4;height:10px;opacity:.8;filter:alpha(opacity=80);cursor:pointer}.vcp-slider .vcp-slider-track{width:0;height:100%;margin-top:0;opacity:1;filter:alpha(opacity=100);background-color:#1e90ff}.vcp-slider .vcp-slider-thumb{cursor:pointer;background-color:#fff;position:absolute;top:0;left:0;border-radius:1em!important;height:10px;margin-left:-5px;width:10px}.vcp-slider-vertical{position:relative;height:4px;z-index:1001;border-radius:4px;background-color:#6e6e6e;opacity:1;filter:alpha(opacity=100);cursor:pointer}.vcp-slider-vertical .vcp-slider-track{background-color:#f9743a;border-radius:4px;// width:.5em;height:100%;opacity:1;filter:alpha(opacity=100)}.vcp-slider-vertical .vcp-slider-thumb{cursor:pointer;position:absolute;background-color:#fff;width:8px;height:8px;border-radius:50%!important;margin-top:-2px;margin-left:-4px;top:0;// left:-.15em}.vcp-timeline{top:-10px;left:0;height:10px;position:absolute;z-index:1001;width:100%}.vcp-timeline .vcp-slider-thumb{top:-4px}.vcp-timeline .vcp-slider{margin-top:8px;height:2px;width:100%}.vcp-timeline:hover .vcp-slider{margin-top:0;height:10px}.vcp-timeline:hover .vcp-slider-thumb{display:block;width:16px;height:16px;top:-3px;margin-left:-8px}.vcp-timelabel{display:inline-block;line-height:3em;float:left;color:#fff;padding:0 9px}.vcp-timelabel,.vcp-volume{height:100%;z-index:1001;position:relative}.vcp-volume{left:48px;width:80px;cursor:pointer;float:left;background-color:transparent;opacity:1;filter:alpha(opacity=100)}.vcp-volume-icon{background:url(//img.17kuxiu.com/web/live/kuxiu/img/audio.png) no-repeat;background-position:11px 11px;display:inline-block;width:36px;height:36px;position:absolute;left:0;top:0}.vcp-volume-muted .vcp-volume-icon{background:url(//img.17kuxiu.com/web/live/kuxiu/img/mute.png) no-repeat;background-position:11px 11px}.vcp-volume .vcp-slider-vertical{top:18px;left:46px}.vcp-volume .vcp-slider-track{position:absolute;bottom:0}.vcp-volume:hover .vcp-slider-vertical{display:block}.vcp-volume .vcp-volume-bg{height:24px;width:126px;position:absolute;left:36px;top:6px;background:0 0;display:none}.vcp-volume:hover .vcp-slider-vertical,.vcp-volume:hover .vcp-volume-bg{display:block}.vcp-fullscreen-toggle{position:relative;width:36px;height:36px;float:right;cursor:pointer;z-index:1001;background:url(//img.17kuxiu.com/web/live/kuxiu/img/full-screen.png) no-repeat;background-position:11px 11px}.vcp-fullscreen .vcp-fullscreen-toggle{background:url(//img.17kuxiu.com/web/live/kuxiu/img/scale.png) no-repeat}.vcp-loading{box-sizing:border-box;background-clip:padding-box;width:50px;height:50px;position:absolute;top:50%;left:50%;margin:-25px 0 0 -25px;text-indent:-9999em}.vcp-loading:before{box-sizing:inherit;content:"";display:none;width:100%;height:100%;border-radius:50%;border:3px solid hsla(0,0%,100%,0);border-left-color:#fff;border-right-color:#fff;-webkit-transform:translateZ(0);transform:translateZ(0);-webkit-animation:load8 1.1s infinite linear;animation:load8 1.1s infinite linear}@-webkit-keyframes load8{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}@keyframes load8{0%{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}.vcp-poster{position:absolute;left:0;top:0;overflow:hidden;z-index:1000;width:100%;height:100%;display:none}.vcp-poster-pic{position:relative}.vcp-poster-pic.cover,.vcp-poster-pic.default{left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}.vcp-poster-pic.cover{width:100%}.vcp-poster-pic.stretch{width:100%;height:100%}.vcp-error-tips{position:absolute;z-index:1001;width:100%;height:4.5em;left:0;top:50%;color:#ff4500;margin-top:-5.25em;text-align:center;display:none}.vcp-clarityswitcher{height:3em;width:3em;cursor:pointer;position:relative;z-index:1001;float:right;background-color:transparent;opacity:.9}.vcp-vertical-switcher-container{width:3em;position:absolute;left:0;bottom:2.4em;background:#242424;display:none}.vcp-vertical-switcher-current{display:block;color:#fff;text-align:center;line-height:3em}.vcp-vertical-switcher-item{display:block;color:#fff;text-align:center;line-height:2em}.vcp-vertical-switcher-item.current{color:#888}.vcp-share>a{width:3em;height:3em;cursor:pointer;background-image:url(//imgcache.qq.com/open/qcloud/video/vcplayer/img/share_btn.png);opacity:.9;display:block}.vcp-share{width:3em;height:3em;position:relative;float:right;z-index:1001}.vcp-vertical-share-container{width:auto;height:auto;position:absolute;background:rgba(36,36,36,.8);padding:.5em;overflow:hidden;display:none}@-webkit-keyframes fadeOut{0%{opacity:1}to{opacity:0}}@keyframes fadeOut{0%{opacity:1}to{opacity:0}}.fadeOut{-webkit-animation:fadeOut ease .8s;animation:fadeOut ease .8s;animation-fill-mode:forwards;-webkit-animation-fill-mode:forwards}@-webkit-keyframes fadeIn{0%{opacity:0}to{opacity:1}}@keyframes fadeIn{0%{opacity:0}to{opacity:1}}.fadeIn{-webkit-animation:fadeIn ease .8s;animation:fadeIn ease .8s;animation-fill-mode:forwards;-webkit-animation-fill-mode:forwards}', ""])
    },
    function(e, t) {
        e.exports = function() {
            var e = [];
        ...
        w = function(e) {
            ...
            t.prototype.load = function(e, t) {
                ...
                if (!g.IS_ENABLED_MSE || !i && !o || g.IS_X5TBS && this.player.options.x5_player || i && g.IS_MAC && g.IS_SAFARI && !g.IS_IOS) {
                    ...
                    }) : this.__hlsLoaded(e)) : o && (this.__type = f.VideoType.FLV, "undefined" == typeof window.flvjs ? h.loadScript("//img.17kuxiu.com/web/static/js/flv-1.5.0.min.js",
                    function() {
            ...
            t.prototype.notify = function(e, t) {
                ...
                try {
                    ...
                    case "seekState":
                        ...
                        if (t.seekState == m.SeekStates.SEEKING) {
                            i.type = p.MSG.Seeking
                        } else {
                            if (t.seekState != m.SeekStates.SEEKED) {
                                return
                            }
    ...
    function(e, t, i) {
        ...
        y = function(e) {
            ...
            t.prototype.mousemove = function(e) {
                ...
                this.vertical ? (this.__percent = 1 - t.x, this.thumb.style.left = 100 * (1 - this.__percent) + "%") : (this.__percent = t.y, this.thumb.style.top = 100 * (1 - this.__percent) + "%"),
            ...
            t.prototype.percent = function(e) {
                return e || 0 == e ? (this.__percent = e, void(this.vertical ? this.thumb.style.left = 100 * (1 - this.__percent) + "%": this.thumb.style.top = 100 * this.__percent + "%")) : this.__percent
            },
            t
        } (c["default"]);
        t["default"] = y
    ...
    function(e, t, i) {
        ...
        f = {
            ...
            UrlEmpty: "请填写视频播放地址。",
            FileProtocol: "请勿在 file 协议下使用播放器，可能会导致视频无法播放。",
        ...
        c = function() {
            ...
            e.prototype.reportFlash = function() {
                if (window.MtaH5) {
                    ...
                    t = "unknown";
                    e.isFormat("rtmp") ? t = "rtmp": e.isFormat("flv") ? t = "flv": e.isFormat("m3u8") ? t = "m3u8": e.isFormat("mp4") && (t = "mp4");
                    var i = {
